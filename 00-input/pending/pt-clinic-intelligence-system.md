...
Discover (Google Maps)
  ↓
Analyze Pain (Google Reviews)
  ↓
Enrich Contact (Website → Business Profile → Pattern Generation)
  ↓
Score & Prioritize (AI Analysis)
  ↓
Generate Outreach (Evidence-Based Email)
  ↓
Store & Alert (Supabase + Gmail)
```
...
## Priority
- [x] Critical (blocks revenue generation)
